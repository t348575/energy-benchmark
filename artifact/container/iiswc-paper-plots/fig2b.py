...
def plot_power_range(LABELS, y1, y2, filename, ylim):
    ...
    fig.clf()
    print("see ", f'./plots/{filename}')

plot_power_range(['SSDs', 'CPU', 'PDU1', 'PDU2'], [13.6, 167.5, 128.76, 131.9], [0.77, 24.8, 87.7, 79.16], 'server-range-per-PDU.pdf', 200)
plot_power_range(['SSDs', 'CPU', 'Server'], [13.6, 167.5, 260.71], [0.45, 24.8, 167], 'server-range-merged-PDU.pdf', 300)
